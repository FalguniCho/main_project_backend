...
EMPLOYMENT_CHOICE = [('business','business'),('employee','employee')]


BUSINESS_TYPE = [('coaching','coaching'),('hotel','hotel')]

APPLICATION_STATUS = [('successfull','successfull'),('process','process')]
...
DOCUMENT_STATUS_CHOICE = [('onhold','onhold'),('approve','approve')]
